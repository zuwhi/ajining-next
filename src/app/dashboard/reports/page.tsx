...
export default function ReportsPage() {
  ...
  const exportToExcel = () => {
    const data = transactions.map((transaction) => ({
      ...
      Category: transaction.categoryCash?.name ?? "Uncategorized",
    }));
    ...
    <div>
      ...
      <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex gap-2">
          ...
          <div className="relative">
            ...
            />
            <Button
              className="rounded-xl border border-teal-200 bg-white text-teal-700 shadow-md transition-all hover:bg-teal-50"
      ...
      <div className="mb-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
        ...
        <div className="rounded-xl border border-teal-100 bg-white p-4 shadow-md">
          ...
          <p
            className={`mt-2 text-2xl font-bold ${totalKredit - totalDebet >= 0 ? "text-teal-600" : "text-rose-600"}`}
          >
            ...
            <TableBody>
              {transactions.map((transaction) => (
                ...
                >
                  ...
                  <TableCell
                    className={
                      transaction.type === 1 ? "text-teal-600" : "text-rose-600"
                    }
                  >
