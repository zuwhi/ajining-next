...
export const COLLECTION_ORDER_ID =
  process.env.NEXT_PUBLIC_APPWRITE_ORDER_COLLECTION!;
export const COLLECTION_NOTA_ID =
  process.env.NEXT_PUBLIC_APPWRITE_NOTA_COLLECTION!;
export const COLLECTION_NOTA_DETAIL_ID =
  process.env.NEXT_PUBLIC_APPWRITE_NOTA_DETAIL_COLLECTION!;
